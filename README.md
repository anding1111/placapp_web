...
4. **`personal_access_tokens`**: Utilizada por Laravel Sanctum para la autenticación basada en tokens (API), permitiendo accesos seguros desde aplicaciones móviles o clie## 🚀 Despliegue en Producción (raptor.mipos.pro)

Para desplegar esta aplicación en tu subdominio independiente, por favor sigue la:

### 📖 [Guía Maestra de Despliegue (Raíz de Subdominio)](./produccion_deployment.md)

Esta guía contiene las instrucciones corregidas para realizar un despliegue seguro y organizado dentro de la carpeta raíz de tu subdominio, incluyendo los ajustes necesarios de `index.php` y seguridad por `.htaccess`.
